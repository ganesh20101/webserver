...
# Define the custom port number
$CustomPort = 5986

# Define the rule name
$RuleName = "CustomPortRule"

# Add an inbound rule for the custom port
...
# Add an outbound rule for the custom port
...
Write-Host "Inbound and Outbound rules for port $CustomPort have been created successfully."

# Define the rule name
$RuleName = "ICMPv4Rule"

# Add an inbound rule for ICMPv4
New-NetFirewallRule -DisplayName "$RuleName-Inbound" `
                    -Direction Inbound `
                    -Action Allow `
                    -Protocol ICMPv4 `
...
# Add an outbound rule for ICMPv4
New-NetFirewallRule -DisplayName "$RuleName-Outbound" `
                    -Direction Outbound `
                    -Action Allow `
                    -Protocol ICMPv4 `
...
Write-Host "Inbound and Outbound rules for ICMPv4 have been created successfully."
